			...
			<Wrapper>
				<LocaDiv>
					...
					<div>
						<Text>이메일</Text>
						<EmailInputs>
							<TextInput disabled={certifitions.certiFirst} name="email" type="email" value={email} onChange={OnChange}></TextInput>
							<CertiBtn disabled={certifitions.certiFirst} onClick={Certifition}>인증</CertiBtn>
						</EmailInputs>
					...
					<div>
						<Text>이메일 인증 번호</Text>
						<EmailInputs>
							<TextInput disabled={certifitions.certiSecond} name="CertiNum" type="text" value={certiNum} onChange={OnChange}></TextInput>
							<CertiBtn disabled={certifitions.certiSecond} onClick={CertiNum}>확인</CertiBtn>
						</EmailInputs>
					</div>
					<div>
						<Text>이름</Text>
